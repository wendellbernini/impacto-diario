  ...
  useEffect(() => {
    const fetchCienciaNews = async () => {
      try {
        ...
        // Buscar outras notícias de Ciência
        ...
        console.error('Erro ao buscar notícias de Ciência:', error);
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="min-h-screen category-page-container">
      ...
      <div className="text-center py-12">
        ...
        <p className="news-body text-xl text-gray-100 mb-4 max-w-3xl mx-auto">
          Descobertas científicas, pesquisas e inovações tecnológicas.
        </p>
      </div>
                ...
                >
                  <div className="p-6">
                    ...
                    <p className="news-body text-gray-600 text-lg leading-relaxed mb-4">
                      {featuredNews.summary || 'Leia mais sobre esta importante descoberta científica...'}
                    </p>
