...
const PoliticaPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchPoliticaNews = async () => {
      try {
        // Buscar notícia em destaque de Política
        const { data: featured, error: featuredError } = await supabase
          .from('news')
          .select('*')
          .eq('category', 'politica')
          .eq('is_featured', true)
        ...
        // Buscar outras notícias de Política
        ...
        console.error('Erro ao buscar notícias de Política:', error);
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="min-h-screen category-page-container">
      ...
      <div className="text-center py-12">
        ...
        <p className="news-body text-xl text-gray-100 mb-4 max-w-3xl mx-auto">
          Acompanhe as principais notícias políticas do Brasil e do mundo.
        </p>
      </div>
                ...
                >
                  <div className="p-6">
                    ...
                    <p className="news-body text-gray-600 text-lg leading-relaxed mb-4">
                      {featuredNews.summary || 'Leia mais sobre esta importante notícia política...'}
                    </p>
