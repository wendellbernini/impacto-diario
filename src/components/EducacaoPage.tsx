  ...
  useEffect(() => {
    const fetchEducacaoNews = async () => {
      try {
        ...
        // Buscar outras notícias de Educação
        ...
        console.error('Erro ao buscar notícias de Educação:', error);
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="min-h-screen category-page-container">
      ...
      <div className="text-center py-12">
        ...
        <p className="news-body text-xl text-gray-100 mb-4 max-w-3xl mx-auto">
          Notícias sobre educação, ensino e políticas educacionais.
        </p>
      </div>
                ...
                >
                  <div className="p-6">
                    ...
                    <p className="news-body text-gray-600 text-lg leading-relaxed mb-4">
                      {featuredNews.summary || 'Leia mais sobre esta importante notícia de educação...'}
                    </p>
