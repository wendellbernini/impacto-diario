...
const SegurancaPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchSegurancaNews = async () => {
      try {
        // Buscar notícia em destaque de Segurança
        const { data: featured, error: featuredError } = await supabase
          .from('news')
          .select('*')
          .eq('category', 'seguranca')
          .eq('is_featured', true)
        ...
        // Buscar outras notícias de Segurança
    ...
    <div className="min-h-screen category-page-container">
      ...
      <div className="text-center py-12">
        ...
        <p className="news-body text-xl text-gray-100 mb-4 max-w-3xl mx-auto">
          Notícias sobre segurança pública, cibernética e defesa nacional.
        </p>
      </div>
                ...
                >
                  <div className="p-6">
                    ...
                    <p className="news-body text-gray-600 text-lg leading-relaxed mb-4">
                      {featuredNews.summary || 'Leia mais sobre esta importante notícia de segurança...'}
                    </p>
