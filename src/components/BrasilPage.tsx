...
const BrasilPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchBrasilNews = async () => {
      try {
        // Buscar notícia em destaque do Brasil
        ...
        // Buscar outras notícias do Brasil
        ...
        // Buscar notícias por subcategorias do Brasil
        ...
        console.error('Erro ao buscar notícias do Brasil:', error);
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="min-h-screen category-page-container">
      ...
      <div className="text-center py-12">
        ...
        <p className="news-body text-xl text-gray-100 mb-4 max-w-3xl mx-auto">
          Cobertura completa sobre os principais acontecimentos do Brasil.
        </p>
                  ...
                  >
                    <div className="p-8">
                      ...
                      <p className="news-body text-gray-600 text-lg leading-relaxed mb-4">
                        {featuredNews.summary || 'Leia mais sobre esta importante notícia do Brasil...'}
                      </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {otherNews.slice(0, 6).map((news) => (
                    ...
                    >
                      ...
                      <p className="news-body text-sm text-gray-600 line-clamp-2 mb-2">
                        {news.summary}
                      </p>
