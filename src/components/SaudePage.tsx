...
const SaudePage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchSaudeNews = async () => {
      try {
        // Buscar notícia em destaque de Saúde
        ...
        // Buscar outras notícias de Saúde
    ...
    <div className="min-h-screen category-page-container">
      ...
      <div className="text-center py-12">
        ...
        <p className="news-body text-xl text-gray-100 mb-4 max-w-3xl mx-auto">
          Notícias sobre saúde pública, medicina e bem-estar.
        </p>
      </div>
                ...
                >
                  <div className="p-6">
                    ...
                    <p className="news-body text-gray-600 text-lg leading-relaxed mb-4">
                      {featuredNews.summary || 'Leia mais sobre esta importante notícia de saúde...'}
                    </p>
